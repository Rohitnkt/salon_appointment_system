  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
                ...
                <br>
                <p>– Creative style salon kundallahalli</p>
            `,
    };
...
app.post("/api/confirm", (req, res) => {
  ...
  try {
    ...
    db.prepare(`UPDATE appointments SET status = 'confirmed' WHERE id = ?`).run(
      id
    );
    ...
    const mailOptions = {
      ...
      html: `
                ...
                <br><p>– Creative style salon kundallahalli</p>
            `,
    };
...
app.post("/api/reject", (req, res) => {
  ...
  try {
    ...
    db.prepare(`UPDATE appointments SET status = 'rejected' WHERE id = ?`).run(
      id
    );
